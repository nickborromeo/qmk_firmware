...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT_ortho_4x12(
      ...
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_PIPE,
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLS,
      KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_SPC, KC_SPC, KC_LPRN, KC_RPRN, KC_NO, KC_UNDS, KC_PEQL
      ),
	[2] = LAYOUT_ortho_4x12(
      LGUI(KC_GRV), KC_MUTE, KC_VOLD, KC_VOLU, KC_NO, RESET, KC_NO, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_BSPC,
      KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_BSLS,
      KC_NO, KC_NO, KC_CUT, KC_COPY, KC_PSTE, KC_NO, KC_NO, KC_P1, KC_P2, KC_P3, KC_PAST, KC_ENT,
