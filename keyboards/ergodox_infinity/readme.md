...
for the left and right halves seperately.  To flash them:
  ...
  - Build the firmware with `make ergodox_infinity:nikkilas`

  - Plug in the left hand keyboard only.

  - Press the program button (back of keyboard, above thumb pad).

  - Install the firmware with `sudo make ergodox_infinity:nikkilas:dfu-util`

  - Build right hand firmware with `make ergodox_infinity:nikkilas MASTER=right`

  - Plug in the right hand keyboard only.

  - Press the program button (back of keyboard, above thumb pad).

  - Install the firmware with `sudo make ergodox_infinity:nikkilas:dfu-util MASTER=right`
